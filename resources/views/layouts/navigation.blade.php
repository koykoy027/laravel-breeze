            ...
            <ul
                ...
                <li>
                    <a href="{{ route('dashboard') }}"
                        ...
                        @php if (url()->current() === route('dashboard')): @endphp
                ...
                <li>
                    <a href="{{ route('about') }}"
                        class="block py-2 pl-3 pr-4 text-gray-700 rounded md:p-0 md:dark:text-blue-500
                        @php if (url()->current() === route('about')): @endphp
                            bg-blue-700 text-white md:bg-transparent md:text-blue-700
                        @php endif; @endphp">
                        About
                    </a>
                ...
                <li>
                    <a href="{{ url('services') }}"
                        class="block py-2 pl-3 pr-4 text-gray-700 rounded md:p-0 md:dark:text-blue-500
                        @php if (url()->current() === url('services')): @endphp
                            bg-blue-700 text-white md:bg-transparent md:text-blue-700
                        @php endif; @endphp">
                        Services
                    </a>
                ...
                <li>
                    <a href="{{ url('pricing') }}"
                        class="block py-2 pl-3 pr-4 text-gray-700 rounded md:p-0 md:dark:text-blue-500
                        @php if (url()->current() === url('pricing')): @endphp
                            bg-blue-700 text-white md:bg-transparent md:text-blue-700
                        @php endif; @endphp">
                        Pricing
                    </a>
